...
public class WebApp {
	...
	InetSocketAddress address = new InetSocketAddress("0.0.0.0", portNumber);
	...
	System.out.println("REQUEST HANDLER TRIGGERED");
	try {
	    ...
	    System.out.println("PROMPTS CONTENT: " + prompts);
